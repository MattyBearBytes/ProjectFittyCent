...
namespace FittyCent.Web {
    public static class HtmlExtensions {
        ...
        public static MvcHtmlString FormGroupCheckBoxFor<TModel>(this HtmlHelper<TModel> html, Expression<Func<TModel, bool>> expression) {
            return CreateEditorFor(html, expression, html.CheckBoxFor);
        }
